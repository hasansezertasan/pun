...
**Do not create new top-level subpackages under `src/pun/`.**
...
- Source lives in `src/pun/`; tests mirror it under `tests/`.
- `src/pun/_version.py` is generated by hatch-vcs — never edit it.
